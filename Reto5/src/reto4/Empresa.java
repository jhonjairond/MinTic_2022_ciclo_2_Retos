...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static ArrayList<Double> liquidarNominaEmp(ArrayList<Empleado> empleados) {
        ...
        if (empleados == null) {
            ...
            for (Empleado empleado : empleados) {
                ...
                valoresALiquidar.add(salarioMensualExtrasTransporteSaludPensional);
            }
    ...
    public static ArrayList<Double> totalPagosOtorgadosAEmpleados(ArrayList<Empleado> empleados) {
        ArrayList<Double> empleadoTotalPago = new ArrayList<Double>();

        if (empleados == null) {
            return null;
        } else {
            for (int i = 0; i < empleados.size(); i++) {
                empleadoTotalPago.add(liquidarNominaEmp(empleados).get(i) + liquidarPrestacionesEmp(empleados).get(i));
            }
        }

        return empleadoTotalPago;
    }
